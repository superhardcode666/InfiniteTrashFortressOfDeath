...
namespace QFSW.QC.Demo
{
    ...
    {
        [Command("speed")] private static readonly float robotSpeed = 25f;

        [Command("rotation-speed")] private static readonly float robotRotationSpeed = 40f;
        ...
        {
            Robot robot = default;
            var robots = InvocationTargetFactory.FindTargets<Robot>(MonoTargetType.All);
