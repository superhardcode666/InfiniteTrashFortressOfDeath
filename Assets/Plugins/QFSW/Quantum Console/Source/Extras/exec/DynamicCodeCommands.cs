...
namespace QFSW.QC
{
    ...
    {
        private const Platform execAvailability =
 Platform.AllPlatforms ^ (Platform.WebGLPlayer | Platform.IPhonePlayer | Platform.XboxOne | Platform.PS4 | Platform.Switch);
 ...
 new string[] { "System", "System.Collections", "System.Collections.Generic",
                    ...
                    for (int i = 0; i < includedNamespaces.Length; i++) { fullCode +=
 $"using {includedNamespaces[i]};\n"; }
                    fullCode += @"
