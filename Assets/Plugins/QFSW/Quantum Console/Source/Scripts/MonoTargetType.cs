namespace QFSW.QC
{
    ...
    public enum MonoTargetType
    {
        ...
        /// <summary>
        ///     Targets all instances registered in the QuantumConsoleProcessor registry. Instances can be added using
        ///     <c>QFSW.QC.QuantumConsoleProcessor.Register</c>.
        ///     The only supported target type for non MonoBehaviour commands
        /// </summary>
        Registry = 2,

        /// <summary>
        ///     Automatically creates an instance if it does not yet exist and adds it to the registry, where it will be used for
        ///     all future function calls.
        /// </summary>
        Singleton = 3,
