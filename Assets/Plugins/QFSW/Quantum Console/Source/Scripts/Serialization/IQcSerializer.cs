...
namespace QFSW.QC
{
    ...
    public interface IQcSerializer
    {
        ...
        /// <param name="recursiveSerializer">
        ///     Delegate back to the main serializer to allow for recursive serialization of sub
        ///     elements.
        /// </param>
        /// <returns>The serialized result.</returns>
        string SerializeFormatted(object value, QuantumTheme theme,
