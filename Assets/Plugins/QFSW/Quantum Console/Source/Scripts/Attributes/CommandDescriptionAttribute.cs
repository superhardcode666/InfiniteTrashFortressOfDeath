...
{
    /// <summary>
    ///     Provides a command with a description. If the [Command] attribute already provides a description, that will
    ///     supersede this one. Useful for when you have several [Command]s on a single method.
    /// </summary>
