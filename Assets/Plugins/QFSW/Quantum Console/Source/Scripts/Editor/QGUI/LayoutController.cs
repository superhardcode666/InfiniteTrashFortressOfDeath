...
namespace QFSW.QC.QGUI
{
    public class LayoutController
    {
        ...
        {
            var width = _currentRect.width * widthPercentage;
        ...
        {
            var width = _currentRect.width / colCount;
            for (var i = 0; i < rects.Length; i++) rects[i] = ReserveHorizontal(width);
        }
