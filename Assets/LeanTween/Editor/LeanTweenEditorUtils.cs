...
public static class LeanTweenEditorUtils
{
    ...
    ///     This way Leantween does not require to reload the domain or scene when entering the playmode (available since
    ///     2019.3)
    /// </summary>
    /// <param name="state"></param>
    private static void OnPlayModeStateChanged(PlayModeStateChange state)
    {
        if (state == PlayModeStateChange.EnteredEditMode) LeanTween.reset();
    }
}